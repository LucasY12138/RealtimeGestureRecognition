...
class ReplayBuffer:
    ...
    def __init__(self, obs_dim, act_dim, size, clip_limit, spike_ts=5, cn_length=1000, norm_update_every=1000):
        ...
        :param spike_ts: simulation duration for a single step
        :param cn_length: the total number of variables using colored noise in the network
